...
| `agents` | exactly three rows, `position` 1..3, `name` (unique, no `:`), `personality` text (size-limited), `biography` text (public, shown to visitors), `voice_id`, `voice_name`, `has_one_attached :avatar` |
